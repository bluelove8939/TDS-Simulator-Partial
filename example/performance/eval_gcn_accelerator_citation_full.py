...
if __name__ == "__main__":
    ...
    model = CitationFullGCN(in_features=dataset.num_node_features, out_features=dataset.num_classes)
    ...
    device = GCNAccelerator(pe_num=8, mac_per_pe=32, cache_capacity=128*1024, cache_way_num=32)
    device_config = GCNAcceleratorConfig(device=device)
